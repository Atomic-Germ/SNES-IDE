...
def test_main_passes_install_dir_and_min_space(monkeypatch, tmp_path):
    ...
    class FakeInstaller:
        def __init__(self, config_file, dry_run=False, min_free_bytes=None, install_dir=None):
    ...
    sys_argv = ['snes_installer', '--dry-run', '--install-dir', str(tmp_dir), '--min-space', '500', '--tools', 'ca65']
