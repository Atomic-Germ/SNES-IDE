...
# Interactive prompts
$userDirectory = Read-Host "Enter the desired directory (e.g., C:\\Users\\anonymous\\Desktop\\game_folder)"
$MemoryMap = Read-Host 'HIROM or LOROM (choose LOROM if unsure)?'
$Speed = Read-Host 'Speed: use FAST or SLOW? Write FAST or SLOW:'
